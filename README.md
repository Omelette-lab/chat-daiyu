...
> 微调后的模型已上传至[chat黛玉语音](https://www.modelscope.cn/models/Omelette/chat-daiyu-sovits/files)
...
## Features
- [x] 文本数据收集：小说、剧本、网络改编黛玉语录
- [x] 文本数据处理：chat-GPT提取小说、剧本对话，生成网络改编黛玉语录对话集
- [x] 文本对话模型训练：xtuner微调
- [x] 语音数据收集：87剧版红楼梦提取黛玉音频
- [x] 语音数据处理：降噪、切分、对标音频文本
- [x] 语音对话模型训练
- [x] 前端界面设计
- [x] 模型函数接口编写
- [x] 前后端整合联调
